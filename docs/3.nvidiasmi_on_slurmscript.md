...
- `memory.using[MiB]` - VRAM capacity used — how many bytes are allocated
- `utilization.memory [%]` - Memory bandwidth utilisation — the fraction of time over the sampling window that the memory interface was actively transferring data
